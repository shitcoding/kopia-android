...
class LargeFileRoundTripTest {
    ...
    inner class StandardSizes {
        ...
        fun `should round-trip 10MB file with SHA-256 verification`(): Unit = runBlocking {
    ...
    inner class SplitterBoundary {
        ...
        fun `should round-trip file exactly at splitter boundary`(): Unit = runBlocking {
        ...
        fun `should round-trip file at splitter boundary plus one byte`(): Unit = runBlocking {
    ...
    inner class CompressionBehavior {
        ...
        fun `should handle file with highly compressible content at 50MB`(): Unit = runBlocking {
        ...
        fun `should handle file with incompressible content at 50MB`(): Unit = runBlocking {
            val size = 50 * 1024 * 1024
    ...
    inner class StressSizes {
        ...
        fun `should round-trip 50MB file with SHA-256 verification`(): Unit = runBlocking {
            val size = 50 * 1024 * 1024
        ...
        fun `should round-trip 100MB file with SHA-256 verification`(): Unit = runBlocking {
